...
verify() {
  ...
  check "powerpc-eabi-gcc (GameCube/Wii)" "$DEVKITPPC/bin/powerpc-eabi-gcc" --version
  check "aarch64-none-elf-gcc (Switch)" "$DEVKITA64/bin/aarch64-none-elf-gcc" --version
